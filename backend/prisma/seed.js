...
async function main() {
  ...
  const packageDefs = [
    {
      name: 'Basic',
      price: 100000, maxBranches: 1, maxStaff: 4,
      staffPerExtraBranch: 3, staffAddonPrice: 25000, staffAddonType: 'onetime',
    ...
    {
      name: 'Pro',
      price: 150000, maxBranches: 1, maxStaff: 8,
      staffPerExtraBranch: 5, staffAddonPrice: 0, staffAddonType: 'monthly',
    ...
    {
      name: 'Enterprise',
      price: 300000, maxBranches: 1, maxStaff: 14,
      staffPerExtraBranch: 0, staffAddonPrice: 0, staffAddonType: 'monthly',
