        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 border-b border-[#2A2A2A]">
              <Search size={18} className="text-[#E0A82E] flex-shrink-0" aria-hidden="true" />
              <input
                ref={inputRef}
                role="combobox"
              ...
              {query.length > 1 ? (
                <div className="py-2 max-h-80 overflow-y-auto">
                  {results.length > 0 ? results.map((r, i) => (
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-[#E0A82E]/10 flex items-center justify-center flex-shrink-0">
                        <r.icon size={15} className="text-[#E0A82E]" aria-hidden="true" />
                      </div>
                      ...
                      <div className={`flex items-center gap-2 transition-opacity ${activeIndex === i ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
                        ...
                        <ArrowRight size={13} className="text-[#E0A82E]" aria-hidden="true" />
                      </div>
                    </button>
                  )) : (
                  ...
                  <div>
                    ...
                    <div className="space-y-0.5">
                      {shortcuts.map((item, i) => (
                        ...
                        >
                          <div className="w-7 h-7 rounded-lg bg-[#E0A82E]/10 flex items-center justify-center flex-shrink-0">
                            <item.icon size={14} className="text-[#E0A82E]" aria-hidden="true" />
                          </div>
