    ...
    items: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Untuk barber, pilih skema gaji: Komisi, Gaji Pokok, atau Pokok + Komisi.',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Tiap barber bisa diatur skema gajinya di menu Staf: Komisi (% omzet), Gaji Pokok (tetap per bulan), atau Pokok + Komisi. Fitur "Gaji Barber" menghitung gaji tiap barber otomatis sesuai skemanya — tetapi pembayaran tetap Anda yang mencatat.',
        steps: [
          'Atur skema gaji tiap barber di menu Staf (Komisi / Gaji Pokok / Pokok + Komisi).',
          'Di halaman Pengeluaran, klik tombol "Gaji Barber".',
          'Muncul daftar gaji tiap barber untuk bulan yang dilihat, lengkap dengan rinciannya.',
          'Klik "Catat" — form pengeluaran terisi otomatis (kategori Gaji & Honor, nominal = gaji).',
          'Periksa nominalnya (boleh diubah bila berbeda), lalu simpan. Barber yang sudah dicatat ditandai "✓ Dicatat".',
        ],
        to: '/admin/expenses',
        toLabel: 'Buka Pengeluaran',
      },
