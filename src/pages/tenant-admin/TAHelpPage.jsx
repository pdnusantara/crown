    ...
    items: [
      {
        ...
        steps: [
          ...
          'Atur "Toleransi terlambat", "Akurasi GPS maksimum", dan nyalakan "Auto check-out" bila perlu.',
          'Aktifkan "Wajib foto selfie" agar staf mengambil foto tiap absen sebagai bukti kehadiran, lalu Simpan Konfigurasi.',
        ],
        to: '/admin/attendance',
    ...
    items: [
      {
        ...
        a: 'Pengaturan mencakup profil toko, data faktur, tampilan halaman booking publik, zona waktu, notifikasi & pesan WhatsApp, Cetak Struk (catatan kaki, lebar kertas, logo), dan Sistem Poin (cara dapat & tukar poin).',
        to: '/admin/settings',
        toLabel: 'Buka Pengaturan',
      },
      {
        id: 's-cetak-struk',
        q: 'Bagaimana mengatur tampilan struk (catatan kaki, logo, lebar kertas)?',
        a: 'Di Pengaturan → kartu Cetak Struk, Anda bisa menyesuaikan struk yang dicetak kasir — baik cetak biasa maupun printer thermal Bluetooth.',
        steps: [
          'Buka Pengaturan (tab Umum), gulir ke kartu "Cetak Struk".',
          'Isi "Catatan kaki struk" untuk pesan di bawah struk (mis. promo/IG). Gunakan {toko} untuk menyisipkan nama toko; kosongkan untuk teks bawaan.',
          'Pilih "Lebar kertas default" (58mm atau 80mm) sesuai printer toko — kasir tetap bisa menggantinya saat mencetak.',
          'Aktif/nonaktifkan "Tampilkan logo di struk".',
          'Klik Simpan. Struk kasir otomatis mengikuti pengaturan ini.',
        ],
        to: '/admin/settings',
        toLabel: 'Buka Pengaturan',
      },
      {
        id: 's-sistem-poin',
        q: 'Bagaimana mengatur sistem poin loyalti?',
        a: 'Di Pengaturan → kartu Sistem Poin, Anda mengatur sendiri cara pelanggan mendapat & menukar poin: berapa rupiah belanja untuk 1 poin, nilai 1 poin saat ditukar, minimal poin yang bisa ditukar, batas potongan (% subtotal), serta tombol aktif/nonaktif. Ada contoh hitung otomatis agar mudah dipahami. Backend selalu memakai angka ini saat transaksi, jadi tampilan kasir & hasil tersimpan selalu cocok.',
        steps: [
          'Buka Pengaturan (tab Umum), gulir ke kartu "Sistem Poin".',
          'Pastikan "Aktifkan sistem poin" menyala (matikan bila tak ingin pakai poin).',
          'Atur "Belanja per 1 poin", "Nilai 1 poin", "Minimal poin ditukar", dan "Maks. potongan".',
          'Lihat contoh hitung yang muncul untuk memastikan skemanya sesuai.',
          'Klik Simpan — kasir langsung mengikuti aturan baru pada transaksi berikutnya.',
        ],
        to: '/admin/settings',
        toLabel: 'Buka Pengaturan',
      },
      ...
      },
      {
        ...
        steps: [
          ...
          'Atur jeda acak antar pesan (mis. 8–30 detik) — mencegah pola pengiriman beruntun yang berisiko memblokir nomor WhatsApp.',
          'Tulis teks pesan — gunakan {nama}, {toko}, dan {hari} sebagai placeholder.',
          'Simpan. Gunakan "Kirim Pengingat Sekarang" untuk mengirim langsung; pengiriman berjalan bertahap di latar belakang.',
        ],
        to: '/admin/settings',
        toLabel: 'Buka Pengaturan',
      },
