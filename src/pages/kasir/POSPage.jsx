  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl p-5 text-center"
        style={{ background: 'linear-gradient(135deg, rgba(109, 95, 232,0.18) 0%, rgba(109, 95, 232,0.06) 100%)', border: '1px solid rgba(109, 95, 232,0.30)' }}>
          ...
          <div>
            ...
            <div className="relative">
              <span
                ...
                style={{ color: cashReceived > 0 ? '#6D5FE8' : 'var(--muted, #6b7280)' }}
              >
                Rp
              </span>
              <input
                  ...
                  return (
                    <button
                      ...
                      className={`relative rounded-xl border px-3 py-3 text-center transition-all active:scale-95 ${
                        isSelected
                          ? 'bg-brand/15 border-brand text-brand shadow-[0_0_0_3px_rgba(109, 95, 232,0.15)]'
                          : isExact
